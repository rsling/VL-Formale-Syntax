...
Ebenfalls aus Kompatibilitätsgründen:\\
Reihenfolge in der \subcatl: \type{nom}, \type{acc}, \type{dat}.

In neueren Arbeiten \citep{MuellerLFGphrasal,MuellerGermanic}: \type{nom}, \type{dat},
\type{acc}.
...
\begin{forest}
sm edges
[{V[\subcat \sliste{}]},visible on=4-
  [{\ibox{1} NP[\type{nom}]},visible on=3-
    [Aicke,visible on=3-]]
  [{V[\subcat \sliste{ \ibox{1} }] },visible on=2-
    [{\ibox{2} NP[\type{acc}]} 
      [Conny]]
...
[{V[\subcat \sliste{}]},visible on=4-
  [{NP[\type{nom}]},visible on=3- 
    [Aicke,visible on=3-] ]
  [{V[\subcat \sliste{ NP[\type{nom}] }] },visible on=4-
    [{NP[\type{acc}]},visible on=5- 
      [Conny,visible on=5-] ]
    [{V[\subcat \sliste{ NP[\type{nom}], NP[\type{acc}] } ] },visible on=6- [erwartet,visible on=7-]] ] ]
\end{forest}}
